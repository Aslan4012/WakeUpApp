...
class MathChallengeScreen extends StatelessWidget {
  ...
  const MathChallengeScreen({Key? key, required this.alarmId})
      : super(key: key);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GridView.count(
          ...
          children: [
            challengeButton(context, 'x + y', Colors.blue, Icons.add,
                AddMathChallenge(alarmId: alarmId)),
  ...
  Widget challengeButton(BuildContext context, String label, Color color,
      IconData icon, Widget targetScreen) {
